...
-- Usunięcie istniejącego klucza obcego
ALTER TABLE tickets
DROP CONSTRAINT tickets_id_flight_fkey;

-- Dodanie reguły usuwania CASCADE DELETE do klucza obcego
ALTER TABLE tickets
ADD CONSTRAINT tickets_id_flight_fkey
FOREIGN KEY (id_flight)
REFERENCES flights (id_flight)
ON DELETE CASCADE;
-- Usunięcie istniejącej reguły usuwania
ALTER TABLE user_tickets
DROP CONSTRAINT user_tickets_id_ticket_fkey;

-- Dodanie reguły usuwania CASCADE DELETE
ALTER TABLE user_tickets
ADD CONSTRAINT user_tickets_id_ticket_fkey
FOREIGN KEY (id_ticket)
REFERENCES tickets (id_ticket)
ON DELETE CASCADE;

-- Usunięcie istniejącej reguły aktualizacji
ALTER TABLE flights
DROP CONSTRAINT flights_id_connection_fkey;

-- Dodanie reguły usuwania CASCADE DELETE
ALTER TABLE flights
ADD CONSTRAINT flights_id_connection_fkey
