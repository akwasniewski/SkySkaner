...
public class SearchUtils {
    ...
    public static LinkedList<SearchResult> SearchOneStop(String origin, String destination, Date date){
        return null;
    }
    public static Flight GetFlight(int flightId) throws SQLException {
        //first airport;
        String firstCityQuery = "SELECT id_airport, airports.the_name, cities.the_name, code FROM flights NATURAL JOIN connections JOIN airports ON id_airport=id_airport_from JOIN airplanes ON flights.id_airplane=airplanes.id_airplane JOIN cities ON airports.id_city=cities.id_city WHERE id_flight=?";
        ...
        //second airport
        String secondCityQuery = "SELECT id_airport, airports.the_name, cities.the_name, code FROM flights NATURAL JOIN connections JOIN airports ON id_airport=id_airport_to JOIN airplanes ON flights.id_airplane=airplanes.id_airplane JOIN cities ON airports.id_city=cities.id_city WHERE id_flight=?";
